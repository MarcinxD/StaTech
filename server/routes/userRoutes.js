...
//TODO EN PRODUCCION PONEMOS LA FECHA DE CADUCIDAD EN 1 HORA O ASI
const genToken = (id) => {
...
const getUserOrders = asyncHandler(async (req, res) => {
  ...
  if (orders) {
    ...
    res.status(404);
    throw new Error('No se han encontrado pedidos');
  }
});
...
const deleteUser = asyncHandler(async (req, res) => {
  try {
    ...
    tes.status(404);
    throw new Error('Este usuario no se ha podido encontrar.');
  }
});
