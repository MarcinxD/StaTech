...
const ReviewsTab = () => {
  ...
  useEffect(
    () => {
      ...
      if (reviewRemoval) {
        toast({ description: 'La reseña ha sido borrada', status: 'success', isClosable: true });
      }
    },
                  ...
                  <AccordionItem>
                    <h2>
                      <AccordionButton>
                        <Box flex='1'>
                          <Flex>
                            <Text mr='8px' fontWeight='bold'>{product.name}</Text>
                            <Spacer  />
                            <Text mr='8px' fontWeight='bold'>
                              ({product.reviews.length} Reseña/s)
                            </Text>
                          </Flex>
                        </Box>
                      </AccordionButton>
